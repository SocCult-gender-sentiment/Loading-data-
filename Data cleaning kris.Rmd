...
library("genderizeR", "tidyverse")

givenNames <- findGivenNames(newdf$Author.First.Name, progress = FALSE)
...
names(givenNames1)[names(givenNames1) == "name"] <- "Author.First.Name"
names(givenNames1)[names(givenNames1) == "gender"] <- "Author.First.Gender"
names(givenNames1)[names(givenNames1) == "probability"] <- "Author.First.Gender.Probability"
names(givenNames1)[names(givenNames1) == "count"] <- "Author.First.Gender.Count"
names(givenNames1)[names(givenNames1) == "country_id"] <- "Author.First.Gender.Country_ID"
...
givenNamesLast <- findGivenNames(newdf$Author.Last.Name, progress = FALSE)

givenNamesLast <- givenNamesLast %>% 
  mutate(
    name = as.character(name),
    gender = as.character(gender),
    probability = as.numeric(probability),
...
givenNamesLast1 <- givenNamesLast

names(givenNamesLast1)[names(givenNamesLast1) == "name"] <- "Author.Last.Name"
names(givenNamesLast1)[names(givenNamesLast1) == "gender"] <- "Author.Last.Gender"
names(givenNamesLast1)[names(givenNamesLast1) == "probability"] <- "Author.Last.Gender.Probability"
names(givenNamesLast1)[names(givenNamesLast1) == "count"] <- "Author.Last.Gender.Count"
names(givenNamesLast1)[names(givenNamesLast1) == "country_id"] <- "Author.Last.Gender.Country_ID"
