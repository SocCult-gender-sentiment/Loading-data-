...
ggplot(semifinaldf, aes(First.Author.Gender, fill = First.Author.Gender)) + geom_bar()


#How is the gender distribution in general (last author)?

ggplot(semifinaldf, aes(Last.Author.Gender, fill = Last.Author.Gender)) + geom_bar()
...
lengt_words <- sapply(strsplit(semifinaldf$Abstract, " "), length)
range(lengt_words)
lengt_words
